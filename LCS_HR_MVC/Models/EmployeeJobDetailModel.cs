...
namespace LCS_HR_MVC.Models
{
    public class EmployeeJobDetailModel
    {
        ...
        public string JobCode { get; set; } = "00";
        ...
        [Required(ErrorMessage = "Department From Date is required")]
        public DateTime? DeptFromDate { get; set; }
        
        public DateTime? DeptToDate { get; set; }
